...
module.exports.registerUser = asyncMiddleware(async (req, res, next) => {
...
module.exports.login = asyncMiddleware(async (req, res, next) => {
...
module.exports.getSingleUser = asyncMiddleware(async (req, res, next) => {
...
module.exports.getUserCount = asyncMiddleware(async (req, res, next) => {
...
module.exports.deleteUser = asyncMiddleware(async (req, res, next) => {
